...
const { addTask, editTask, getTasks, deleteTask, getCategories } = require("../controllers/tasks.controllers/task.api.controllers");
...
taskRouter.post('/api/categorys',getCategories);
...
// taskRouter.post('/api/categorys',authMiddleware,isPermission(['user',['admin']]),monthlyprogress);
